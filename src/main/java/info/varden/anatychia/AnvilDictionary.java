 ...
 * @author Marius
 */
public class AnvilDictionary {
    private static HashMap<MaterialType, HashMap<String, String>> knownIds = new HashMap<MaterialType, HashMap<String, String>>() {{
        put(MaterialType.BLOCK, new HashMap<String, String>() {{
            put("0", "minecraft:air");
            ...
            put("34", "minecraft:piston_head");
            put("35", "minecraft:wool");
            put("36", "minecraft:piston_extension");
            ...
            put("92", "minecraft:cake");
            put("93", "minecraft:unpowered_repeater");
            put("94", "minecraft:powered_repeater");
            ...
            put("104", "minecraft:pumpkin_stem");
            put("105", "minecraft:melon_stem");
            ...
            put("115", "minecraft:nether_wart");
            put("116", "minecraft:enchanting_table");
            put("117", "minecraft:brewing_stand");
            put("118", "minecraft:cauldron");
            ...
            put("124", "minecraft:lit_redstone_lamp");
            ...
            put("149", "minecraft:unpowered_comparator");
            put("150", "minecraft:powered_comparator");
            ...
            put("165", "minecraft:slime");
            put("166", "minecraft:barrier");
            put("167", "minecraft:iron_trapdoor");
        ...
        put(MaterialType.ITEM, new HashMap<String, String>() {{
        ...
        put(MaterialType.DIMENSION, new HashMap<String, String>() {{
            put("DIM-1", "Nether");
            put("DIM0", "Overworld");
            put("DIM1", "End");
        }});
        put(MaterialType.ENTITY, new HashMap<String, String>());
    }};
    
    public static String getHumanReadableDescription(MaterialType type, String id) {
        HashMap<String, String> typeMap = knownIds.get(type);
        for (String s : typeMap.keySet()) {
            if (s.equals(id)) {
                return typeMap.get(s) + " (" + id + ")";
            }
        }
        return id;
    }
